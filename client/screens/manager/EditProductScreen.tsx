...
type EditProductRouteProp = RouteProp<ManagerProductsStackParamList, "EditProduct">;
...
export default function EditProductScreen() {
  ...
  const product = mockShopProducts.find((p) => p.id === route.params.productId);
  ...
  const handleSave = () => {
    ...
    Alert.alert(
      "Sucesso",
      `O produto "${productName}" foi atualizado com sucesso!`,
      [
        {
          text: "OK",
